...
// runReminderLoop 没秒轮询数据库，到期提醒通过事件总线发布
...
// flushDueReminders 查询当前刻已到期的提醒并发布事件
...
// registerCurrentTime 注册 get_current_time 工具
...
// registerCalculation 注册 run_calculation 工具
...
// registerReminder 注册 set_reminder 工具
...
// parseReminderTime 解析提醒时间，支持 RFC3339、绝对时间以及相对时间（如 10m）
...
// evaluateExpression 用 Go AST 解析并计算数学表达式
